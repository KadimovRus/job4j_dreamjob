...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name1", "description", creationDate, 1, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "name1", "description", creationDate, 1, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(candidate.getId(), "name1",
